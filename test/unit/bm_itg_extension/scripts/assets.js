...
var URLUtils = require('../../../mock/dw/web/URLUtils');

describe('assets', function () {
    var assets = null;

    beforeEach(function () {
        assets = proxyquire('../../../../cartridges/bm_itg_extension/cartridge/scripts/assets', {
    ...
    it('should add a new JavaScript file', function () {
        ...
        assert.equal(assets.scripts[0].src, '../test.js');
    });
    ...
    it('should add a new CSS file', function () {
        ...
        assert.equal(assets.styles[0].src, '../test.css');
    });
