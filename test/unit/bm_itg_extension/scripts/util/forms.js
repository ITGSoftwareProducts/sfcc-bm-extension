...
describe('forms', function () {
    ...
    var formsRequire = proxyquire('../../../../../cartridges/bm_itg_extension/cartridge/scripts/util/forms/forms', {
        'dw/web/FormField': FormField,
        'dw/web/FormAction': FormAction,
        'dw/web/FormGroup': FormGroup,
        './formField': proxyquire('../../../../../cartridges/bm_itg_extension/cartridge/scripts/util/forms/formField', {
